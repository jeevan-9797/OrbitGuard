...
export const OrbitalTwinScreen: React.FC<OrbitalTwinScreenProps> = ({
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      ...
      setSatellitePosition((prev) => {
        ...
        // Sinusoidal orbit path roughly between -75 and +75 lat
  ...
  // Convert lat/lon (-90..90, -180..180) to percentage on Mercator map
  ...
  return (
    <div className="w-full flex flex-col gap-4">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-4">
        {/* Left: Interactive CAD Digital Twin (7 Cols on XL) - Bento Card */}
        <div className="xl:col-span-7 bg-[#0f172a] border border-[#1e293b] rounded-3xl flex flex-col overflow-hidden relative shadow-xl hover:border-cyan-500/30 transition-all">
          ...
          <div className="p-4 border-b border-[#1e293b] flex flex-wrap items-center justify-between gap-3 bg-[#0a1120]/80">
            ...
            {/* View Mode Switcher & Subsystem Layer Tabs */}
          ...
          {(twinViewMode === 'bus-cad' || twinViewMode === 'split') && (
            ...
            {/* Orbital Vector Rings in 3D Space */}
            {showOrbitVectors && (
            ...
            {/* Isometric Satellite Model (SVG with Dynamic Transform) */}
            <div
            ...
            >
              <svg width="420" height="340" viewBox="0 0 420 340" className="overflow-visible">
                <defs>
                  {/* Gradients based on active layer */}
                ...
                {/* Central Bus Chassis (Cubic Hexagonal Prism Wireframe) */}
                <g id="satellite-core">
                  {/* Main box top face */}
                  <polygon
                  ...
                  {/* Internal Subsystems Wireframe Accents */}
                  {activeLayer === 'thermal' && (
                    <g filter="url(#glow)">
                  ...
                  {/* High Gain X-Band Dish Antenna on Top */}
                ...
                {/* Telemetry Annotation Pins / Callouts */}
            ...
            {/* Selected Callout Drawer / Floating Modal */}
            {selectedCallout && (
              <div className="absolute top-4 left-4 max-w-xs p-unit-3 rounded bg-[#010f1f]/90 border border-primary text-xs shadow-lg backdrop-blur-md z-20">
                ...
                <div className="py-2 text-[11px] text-on-surface-variant space-y-1">
                ...
                <div className="flex justify-end pt-1">
                  <button
                    ...
                    className="text-[10px] text-tertiary hover:underline font-mono flex items-center gap-1 cursor-pointer"
                  >
            ...
            <div className="absolute bottom-3 right-3 flex items-center gap-1 bg-[#010f1f]/80 p-1 rounded border border-outline-variant/50 backdrop-blur-xs">
              <button
                onClick={() => {
                  sound.playClick();
            ...
            {/* Viewport Toggles Bottom Left */}
            <div className="absolute bottom-3 left-3 flex items-center gap-2 text-[10px] font-mono text-on-surface-variant">
              <button
        ...
        {/* Right: Orbital Ground Track & Telemetry Subsystems (5 Cols on XL) - Bento Cards */}
        <div className="xl:col-span-5 flex flex-col gap-4">
          ...
          <div className="bg-[#0f172a] border border-[#1e293b] rounded-3xl flex flex-col overflow-hidden shadow-xl hover:border-cyan-500/30 transition-all">
            ...
            <div className="relative h-[220px] w-full bg-[#05070a] overflow-hidden">
              ...
              {/* Dynamic Ground Track SVG Overlay */}
              <svg className="absolute inset-0 w-full h-full pointer-events-none">
                {/* Past Orbit Ground Track (dashed cyan) */}
                <path
                ...
                {/* Next Orbit Ground Track (dotted green) */}
                <path
                ...
                {/* Moving Satellite Diamond & Coverage Cone */}
                <g style={{ transform: `translate(${satCoords.x}%, ${satCoords.y}%)` }}>
                  {/* Conical footprint ellipse */}
                  <ellipse
                    rx="26"
                    ry="15"
                    fill="#4cd7f6"
          ...
          {/* Subsystem Telemetry Gauges Strip - 4 Bento Mini Tiles */}
          <div className="grid grid-cols-2 gap-3">
            {/* Battery Temp Sparkline */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        {/* Agent Cards (8 cols on LG) - Bento Panel */}
        ...
        {/* Sandbox Callout Card (4 cols on LG) - Bento Accent High-Contrast Card */}
